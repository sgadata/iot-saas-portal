...
export const AuthProvider = ({ children }) => {
    ...
    const [isAuthenticated, setIsAuthenticated] = useState(() => {
        const storedAuth = sessionStorage.getItem('sga_iot_auth');
        return storedAuth === 'true';
    });

    const [user, setUser] = useState(() => {
         const storedUser = sessionStorage.getItem('sga_iot_user');
    ...
    const login = (email, password) => {
        ...
        if (email === 'admin@sga.com' && password === 'admin') {
            ...
            setUser(dummyUser);
            sessionStorage.setItem('sga_iot_auth', 'true');
            sessionStorage.setItem('sga_iot_user', JSON.stringify(dummyUser));
            return { success: true };
    ...
    const logout = () => {
        ...
        setUser(null);
        sessionStorage.removeItem('sga_iot_auth');
        sessionStorage.removeItem('sga_iot_user');
    };
